<template>
  ...
  <div :style = "{fontSize: fontSize + 'px'}">
    ...
    <v-container fluid ma-0 pa-0>
      ...
      <v-layout column>
        <v-img
        src="https://cdn57.androidauthority.net/wp-content/uploads/2020/04/Facetime-group-call-on-iPad-and-iPhone.jpg" style="max-width: 100%; display:block; height: auto;">
        ...
        padding-top : 10px;
        padding-left : 10px;
        padding-bottom: 10px;">Audio Calling Versus Video Calling
      </h1>
      </transition>
    </v-layout>
  </v-img>

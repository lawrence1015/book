<template>
  ...
  <div :style = "{fontSize: fontSize + 'px'}">
    ...
    <v-container fluid ma-0 pa-0>
      ...
      <v-layout column>
        <v-img
        src="https://cdn.cultofmac.com/wp-content/uploads/2012/07/Message.jpg" style="max-width: 100%; display:block; height: auto;">
        ...
        padding-top : 10px;
        padding-left : 10px;
        padding-bottom: 10px;">E-Mails Versus Text Messages
      </h1>
      </transition>
    </v-layout>
  </v-img>

<template>
    ...
    <div :style = "{fontSize: fontSize + 'px'}">
      ...
      <v-container fluid ma-0 pa-0>
        ...
        <v-layout column>
          ...
          padding-left : 10px;
          padding-bottom: 10px;
          color: black;">Why are you the best person for this job?
        </h1>
      </v-layout>
    </v-img>
    ...
    <hr width="60%">
        ...
        <ol style="margin: 12px;">
          ...
          <li>
            This will be a big challenge for my personal development.<br />
            ( 이것은 저의 개인적인 발전에 큰 도전이 될 것입니다. )
          </li>
        </ol>
        ...
        <div style="padding : 16px;">
          ...
          <p>
            Why are you the best person for this job? ( Make your own answer. )
          </p>
  ...
  export default {
    ...
    data(){
      ...
      return{
          ...
          {
            name:'B.',
            speech:"My skill is a perfect match for the job requirements. I have the ability to do any job as I know that I'm a versatile person. I am very much aware that this position will be a big challenge for my personal development and I'm very much willing to take it."
          },
          ],
          ...
          {
            name:'B.',
            speech:'제 실력은 직무에 꼭 들어맞습니다. 저는 제가 다재다능한 사람이라는 것을 알고 있기 때문에 어떤 일이든 할 수 있는 능력이 있습니다. 저는 이 자리가 제 개인적인 발전에 큰 도전이 될 것이라는 것을 잘 알고 있으며, 기꺼이 받아들이고 싶습니다.'
          },
          ]

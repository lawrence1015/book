<template>
  ...
  <div :style = "{fontSize: fontSize + 'px'}">
    ...
    <v-container fluid ma-0 pa-0>
      ...
      <v-layout column>
        <v-img
        src="https://static1.jeanlouisdavid.us/articles/4/13/14/4/@/17424-everything-there-is-to-know-about-differ-1280x430-1.jpg" style="max-width: 100%; display:block; height: auto;">
        ...
        padding-top : 10px;
        padding-left : 10px;
        padding-bottom: 10px;">Natural Hair Versus Dyed Hair
      </h1>
      </transition>
    </v-layout>
  </v-img>

<template>
  ...
  <div :style = "{fontSize: fontSize + 'px'}">
    ...
    <v-container fluid ma-0 pa-0>
      ...
      <v-layout column>
        <v-img
        src="https://lensconfidential.files.wordpress.com/2014/11/steal-like-fashion-photographer-3.jpg" style="max-width: 100%; display:block; height: auto;">
        ...
        padding-top : 10px;
        padding-left : 10px;
        padding-bottom: 10px;">Modern Versus Vintage
      </h1>
      </transition>
    </v-layout>
  </v-img>

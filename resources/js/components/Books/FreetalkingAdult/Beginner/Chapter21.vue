...
<v-container fluid ma-0 pa-0>
  ...
  <v-layout column>
    <v-img
           src="//live.staticflickr.com/4862/33052645958_51a0b83f88_k.jpg">
      ...
      >
        ...
        padding-top : 10px;
        padding-left : 10px;
        padding-bottom: 10px;">Superheroes</h1>
      </v-layout>
    </v-img>
...
City. He vastly and hastily gained popularity after his character was introduced.  He has been adapted into movies, books, video games and TV shows.
</p>
...
<ol style="margin: 12px;">
  <li>Are you planning to take __________ on your enemy?
  </li>

  <li>I __________ to Tina that I will attend her party!
  </li>

  <li>That is ___________ a nice dress! I like it!
  </li>

  <li>Gangnam Style is _____________ known all over the world.
  </li>

  <li>We must use our ____________ to help other people and improve the world.
  </li>

  <li>We ___________ packed our bags because we were in a hurry.
  </li>
...
<p>Using adverbs of manner.
</p>

<li style="list-style-type: none;">Adverbs of manner are words that answers the question “how?" and explains the manner to which something is done.
</li>
<li style="list-style-type: none;">They usually (not all) end with -Iy.
</li>
...
<p>
  A. Fill in the blanks with the proper adverb of the words found after the sentences.
</p>

<ol style="margin: 12px;">

  <li>She waited ___________ for three hours. (patient)
  </li>

  <li>They greeted the guests ___________. (politely)
  </li>

  <li>The heroes fought for their country __________. (brave)
  </li>

  <li>These cupcakes are ______________ baked! (nice)
  </li>

  <li>Billy answered his homework _____________. (correct)
  </li>

  <li>Mother ___________ tucked the children to bed. (gentle)
  </li>

  <li>We ___________ understood today's English lesson. (easy)
  </li>

  <li> _______________, the students apologized to their teacher. (respectful)
  </li>

  <li> You should ____________ pack these vases. (careful)
  </li>
...
<p>
B. Change the following words into their adverb forms and make a sentence for each.
</p>
...
<ol style="margin: 12px;">
  <li>Who is your favorite superhero? Why?
  </li>

  <li>Can you tell about his/her story?
  </li>

  <li>Do you think superheroes are real? Why or why not?
  </li>

  <li>Does the world need real superheroes?
  </li>

  <li>Do you want to be a superhero? Why or why not?
  </li>

  <li>What superpower would you like to possess?
  </li>

  <li>What will you do when you become a superhero?
  </li>

  <li>Will you keep your identity as a secret? Why or why not?
  </li>

  <li>Will you ask people to pay you in exchange for the help that you might give them?
  </li>

  <li>Do you want to work with another superhero? Who is it?
  </li>

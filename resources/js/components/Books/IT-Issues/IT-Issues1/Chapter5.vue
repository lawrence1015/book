<template>
  ...
  <div :style = "{fontSize: fontSize + 'px'}">
    ...
    <v-container fluid ma-0 pa-0>
      ...
      <v-layout column>
        <v-img
        src="images/IT-Issues-Unit5.png"  class="center" style="max-width: 100%; display:block; height: auto;">
  ...
  <h3 style="padding-top : 10px;  padding-left : 15px; padding-bottom: 10px;">How can your company benefit from IoT data analytics?
  </h3>
  <hr width="60%">

<template>
  ...
  <div :style = "{fontSize: fontSize + 'px'}">
    ...
    <v-container fluid ma-0 pa-0>
      ...
      <v-layout column>
        <v-img
        src="https://image.freepik.com/free-photo/social-grannies-using-phone_1098-12822.jpg" style="max-width: 100%; display:block; height: auto;">
        ...
        padding-top : 10px;
        padding-left : 10px;
        padding-bottom: 10px;">Should Elderly People Be Forced to Retire?
      </h1>
      </transition>
    </v-layout>
  </v-img>
     ...
     <div style="margin-left: -18px; margin-right: -18px; margin-top: 10px; border-color: #2F4674; border-style: solid; border-width: 2px;">
      ...
      <div style="padding : 16px;">
        ...
        <ol style="margin: 12px;">
          <li>What is the retirement age in your country?</li>
          <li>Do you think that age is the right age for retirement?</li>
          <li>At what age do you want to retire? Why?</li>
        </ol>

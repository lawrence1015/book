<template>
  ...
  <h3 style="padding-top : 10px;  padding-left : 15px; padding-bottom: 10px;">Artificial intelligence makes blurry faces look more than 60 times sharper.</h3>
  <hr width="60%">
  ...
  <div style= "display: flex;">
      ...
      <p>
        ...
        <span style="font-size:18px">생성 모델의 잠재 공간 탐색을 통한 자가진단 사진 업샘플링</span>
      </p>

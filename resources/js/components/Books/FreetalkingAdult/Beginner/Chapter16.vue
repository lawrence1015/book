...
<v-container fluid ma-0 pa-0>
  ...
  <v-layout column>
    <v-img
           src="//live.staticflickr.com/7173/13890819315_65afa9386b_k.jpg">
      ...
      >
        ...
        padding-top : 10px;
        padding-left : 10px;
        padding-bottom: 10px;">The Flora</h1>
      </v-layout>
    </v-img>
...
<ol style="margin: 12px;">
  <li>Roses ________ are beautiful and sweet-smelling.
  </li>

  <li>These tomatoes are __________. They smell really bad!
  </li>

  <li>A ____________ of a man was found in the river! It was shocking!
  </li>

  <li>_____________ in the stomach can make a person sick and thin.
  </li>

  <li>The ___________ in these forests is diverse and interesting.
  </li>
...
<p>
  Who would you like to give the following blossoms to and why?
</p>
  ...
  <v-layout wrap align-content-center>
                        ...
                        <v-flex xs12 md12 >
                            <v-card hover>
                                ...
                                <v-card-media src="//live.staticflickr.com/5514/10425735826_0501359db5_k.jpg">
                                </v-card-media>
  ...
  <v-layout wrap align-content-center>
                        ...
                        <v-flex xs12 md12 >
                            <v-card hover>
                                ...
                                <v-card-media src="https://marketplace.canva.com/MADQ5ZT21Eg/1/screen/canva-untitled-MADQ5ZT21Eg.jpg">
                                </v-card-media>
  ...
  <v-layout wrap align-content-center>
                        ...
                        <v-flex xs12 md12 >
                            <v-card hover>
                                ...
                                <v-card-media src="https://marketplace.canva.com/MADQ5Ru1nD0/1/screen/canva-untitled-MADQ5Ru1nD0.jpg">
                                </v-card-media>

                                <v-card-text>
                                    Apple Blossoms – “I will protect you.”
                                </v-card-text>
                            </v-card>
                        </v-flex>
  ...
  <v-layout wrap align-content-center>
                        ...
                        <v-flex xs12 md12 >
                            <v-card hover>
                                ...
                                <v-card-media src="https://marketplace.canva.com/MADQ5jELNZM/1/screen_2x/canva-untitled-MADQ5jELNZM.jpg">
                                </v-card-media>
  ...
  <v-layout wrap align-content-center>
                        ...
                        <v-flex xs12 md12 >
                            <v-card hover>
                                ...
                                <v-card-media src="https://marketplace.canva.com/MADGyK9m8Y0/4/screen_2x/canva-red-rose-with-silver-ring-macro-detail-MADGyK9m8Y0.jpg">
                                </v-card-media>
  ...
  <v-layout wrap align-content-center>
                        ...
                        <v-flex xs12 md12 >
                            <v-card hover>
                                ...
                                <v-card-media src="https://marketplace.canva.com/MADGxxjSikw/4/screen_2x/canva-purple-cluster-petal-flower-MADGxxjSikw.jpg">
                                </v-card-media>
...
<ol style="margin: 12px;">
  <li>Do you like flowers? Why or why not?
  </li>

  <li>What is your favorite flower? Why?
  </li>

  <li>Have you ever received flowers from anyone?
  </li>

  <li>What were they and for what occasion?
  </li>

  <li>Have you given flowers to anyone? Why or why not?
  </li>

  <li>What flower would you like to receive?
  </li>

  <li>What is the national flower of your country?
  </li>

  <li>Do you like plants and gardening? Why or why not?
  </li>

  <li>What is the weirdest plant or flower you have heard of?
  </li>

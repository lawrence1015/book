<template>
  ...
  <div :style = "{fontSize: fontSize + 'px'}">
    ...
    <v-container fluid ma-0 pa-0>
      ...
      <v-layout column>
        <v-img
        src="https://www.resident360.com/wp-content/uploads/2019/03/Anthology-1.jpg" style="max-width: 100%; display:block; height: auto;">
        ...
        padding-top : 10px;
        padding-left : 10px;
        padding-bottom: 10px;">Apartments Versus Houses
      </h1>
      </transition>
    </v-layout>
  </v-img>

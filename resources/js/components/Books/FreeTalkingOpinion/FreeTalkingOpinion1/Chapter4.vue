                  ...
                  <v-card-text class="px-10">
                    ...
                    <ol class="replace" type = "A" style="font-weight: bold;">
                      <li><span class = "normaltext">
                        나는 지하철 역을 걷고 있었는데 어떤 사람이 나를 위해 열려진 문을 잡아주었어.
                          보통 사람들은 그냥 지나가고 신경을 쓰지 않는데 이 사람은 내가 문을 통과할 때까지 기다려 줄만큼 친절했어.
                          그것은 너무 친절한 행동이야. 믿기 힘들어!
                        </span>
                      </li>
                      <li><span class = "normaltext">
                        와, 나도 사람들이 더 자주 열려진 문을 잡아줬음 좋겠어.
                          나는 다른 사람에게 친절한 사람들이 있는 세상이 더 좋은 세상이라고 생각해.</b>
                      </span>
                      </li>
                    </ol>

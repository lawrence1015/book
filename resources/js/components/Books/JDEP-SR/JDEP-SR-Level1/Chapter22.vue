<template>
  ...
  <div :style = "{fontSize: fontSize + 'px'}">
    ...
    <v-container fluid ma-0 pa-0>
      ...
      <v-layout column>
        <v-img
        src="https://upload.wikimedia.org/wikipedia/commons/a/a5/Georgetown_Jesuit_Residence.jpg" 
        ...
        padding-top : 10px;
        padding-left : 10px;
        padding-bottom: 10px;">University Students
      </h1>
    </v-layout>
  </v-img>

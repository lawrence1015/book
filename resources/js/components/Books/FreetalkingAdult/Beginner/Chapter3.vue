...
<v-container fluid ma-0 pa-0>
  ...
  <v-layout column>
    <v-img
           src="https://marketplace.canva.com/MADGv_dR6A8/6/screen_2x/canva-assorted-color-beads-MADGv_dR6A8.jpg">
...
<ol style="margin: 12px;">
  <li>We fell asleep in the theater because the movie was _____________.
  </li>

  <li> My ________________ towards my enemy is now gone.
  </li>

  <li>Flags ___________ freedom.
  </li>

  <li>I play sports to forget my ___________.
  </li>

  <li>It’s bad to feel __________.  We should be happy for other people!
  </li>
...
<h3 style="padding-top: 7px;  margin-left: -18px; margin-right: -18px; padding-left: 10px; padding-bottom: 10px;  padding-top: 10px; margin-top: 10px; background-color: #a7d7c5;">Translation</h3>
     <div style="padding : 16px;">
       ...
       <p>
          ...
          색깔은 또한 사람들에게 다른 의미를 불러 일으킨다. 예를 들어 빨간색은 사람에 따라 사랑이나 증오를 의미할 수 있다. 파란색은 평화나 슬픔을 의미한다.
       </p>
...
margin-bottom: -10px;">
<v-img
           src="https://marketplace.canva.com/MADGvwjfkYQ/7/screen_2x/canva-abstract-color-painting-MADGvwjfkYQ.jpg"></v-img>
</div>
...
<p>Here are the personality meanings for other colors:
</p>

<li style="list-style-type: none;">Red - Active and brave
</li>

<li style="list-style-type: none;">Violet - Helpful
</li>

<li style="list-style-type: none;">Yellow - Cheerful and active
</li>

<li style="list-style-type: none;">Blue- Peaceful and Calm
</li>

<li style="list-style-type: none;">White - Simple and clean
</li>

<li style="list-style-type: none;">Orange - Sociable
</li>
...
<ol style="margin: 12px;">
  <li>My sister likes to make many friends. She is _______________.
  </li>

  <li>A person with a nice __________ will have happier relationships.
  </li>

  <li>They are always smiling.  They are ______________.
  </li>

  <li>I am really ___________ about ghosts. Are they real?
  </li>
...
<ol style="margin: 12px;">
<li>What did the professor tell the writer?
</li>

<li>Why did the writer search the Internet?
</li>

<li>What color does the writer like?
</li>

<li>What does the color say about the writer?
</li>

<li>What is your personality if you like orange?
</li>

<li>What kind of person likes blue? Violet? Red?
</li>
</ol>
...
<li style="list-style-type: none;">Do I have to write a report today?
</li>
<li style="list-style-type: none;">They do not want to join the team.
</li>
...
<li style="list-style-type: none;">They did not prepare yesterday.
</li>
<li style="list-style-type: none;">You and I did have some differences.
</li>
<li style="list-style-type: none;">My brothers did go to America last year.
</li>
</p>
...
<h3 style="padding-top: 7px;  margin-left: -18px; margin-right: -18px; padding-left: 10px; padding-bottom: 10px;  padding-top: 10px; margin-top: 10px; background-color: #a7d7c5;">Enhance!</h3>
  ...
  <p>Complete the sentences below. Use "do", "does" or "did."
  </p>

  <ol style="margin: 12px;">
    <li>We _________ not want to be late for class
    </li>

    <li> ___________ you go to the library yesterday?
    </li>

    <li>She _________ study always.
    </li>

    <li>I _________ want to become a pilot when I was young.
    </li>

    <li>My sisters _________ not like to eat fatty foods.
    </li>

    <li> ___________ you want to eat now?
    </li>

    <li>Susy and Annie ___________ like baking.
    </li>

    <li>He _______ know about Egypt's history.
    </li>

    <li> _________ she go to Canada last month?
    </li>

    <li>I _________ want some ice cream right now.
    </li>
...
<ol style="margin: 12px;">
  ...
  <li>What is your least favorite color?
  </li>

  <li>What color makes you feel happy?
  </li>

  <li>What color makes you feel sad?
  </li>

  <li>What color do you like to wear the most?
  </li>

  <li>What color do you like to wear the least?
  </li>

  <li>What color do you remember when you say “winter”?
  </li>

  <li>What color do you remember when you say “summer”?
  </li>

  <li>Why do you think colors are important?
  </li>

  <li>Would you like to change the color of the sky or the clouds?
  </li>

  <li>Would you like to change the color of the grass?
  </li>

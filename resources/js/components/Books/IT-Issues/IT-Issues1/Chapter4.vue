<template>
  ...
  <div :style = "{fontSize: fontSize + 'px'}">
    ...
    <v-container fluid ma-0 pa-0>
      ...
      <v-layout column>
        ...
        padding-top : 10px;
        padding-left : 10px;
        padding-bottom: 10px;">The Future of Big Data
      </h1>
    </v-layout>
  </v-img>
  ...
  <h3 style="padding-top : 10px;  padding-left : 15px; padding-bottom: 10px;">The future of big data: 5 predictions from experts for 2020-2025
  </h3>
  <hr width="60%">
